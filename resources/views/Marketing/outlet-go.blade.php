...
<div class="menu-page">
    ...
    <section class="filter-section" style="margin-bottom: 20px;">
        <form method="GET" style="display: flex; gap: 15px; background: rgba(255,255,255,0.8); backdrop-filter: blur(10px); padding: 15px 20px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.03); border: 1px solid rgba(245, 158, 11, 0.2);">
