        ...
        <div class="container-fluid py-3 py-md-4">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted mb-0">
                    Aktivitas PO Supply Chain Management
                </p>
            </div>
                ...
                <div class="card-body p-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-5">
                        <h4 class="fw-bold text-primary mb-0">
                            <i class="bi bi-box-seam me-2"></i>Purchase Order History
                        </h4>
                    </div>
                        ...
                        <table id="orderTable" class="table table-striped table-bordered align-middle text-center mb-0">
                            ...
                            <thead class="table-light sticky-top">
                                <tr>
                                    ...
                                    <!-- <th class="text-center" style="width:200px;">Penanggung Jawab</th> -->
                                    <th class="text-center" style="min-width:100px;">Status</th>
                                    <th class="text-center" style="min-width:100px;">Tanggal Diterima</th>
                                    <th class="text-center" style="min-width:100px;">Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($histories as $index => $his)
                                <tr style="height:56px;">
                                    <td class="text-center">{{ $index + 1 }}</td>
                                    <td class="text-center">{{ $his->no_po }}</td>
                                    <!-- <td class="text-center">{{ $his->user_id }}</td> -->
                                    <td class="text-center">{{ $his->status_po }}</td>
