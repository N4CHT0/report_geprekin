        ...
        <div class="flex flex-col gap-5 border-b border-slate-100 p-6 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Kelola daftar area operasional untuk ticketing.
                </p>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                    <a
                        href="#"
                        class="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-emerald-700">
                        <span>Export</span>
                    </a>
        ...
        <div class="flex items-center justify-between border-b border-slate-100 px-6 py-5">
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-slate-500">
                    List area operasional yang tersedia
                </p>
                    ...
                    <tr class="transition hover:bg-slate-50/70">
                        ...
                        <td class="px-6 py-5">
                            <div class="flex flex-wrap gap-2">
                                ...
                                <form method="POST" action="{{ route('ticketing.master.area.delete', $row->id) }}" onsubmit="return confirm('Hapus area ini?')">
                                    @csrf
                                    @method('DELETE')
                                    <button
                        ...
                        <td colspan="3" class="px-6 py-24 text-center">
                            ...
                            <div class="mx-auto max-w-sm">
                                ...
                                <div class="mt-2 text-sm text-slate-500">
                                    Data area belum tersedia atau hasil pencarian kosong.
                                </div>
...
<div id="modalCreate" class="fixed inset-0 z-50 hidden bg-black/50 p-4">
    <div class="mx-auto mt-20 max-w-lg rounded-3xl bg-white shadow-2xl">
        ...
        <form method="POST" action="{{ route('ticketing.master.area.store') }}">
            @csrf
...
function openEditModal(el) {
    ...
    document.getElementById('editAreaForm').action = '{{ route('ticketing.master.area.update', ['id' => '__ID__']) }}'.replace('__ID__', id);
    document.getElementById('editAreaInput').value = el.dataset.area || '';
}
</script>
