    ...
    <div class="score-form-page">
        ...
        <div class="score-layout">
                    ...
                    <div class="excel-box-body">
                        <div class="field-grid">
                            <div class="field-col-6">
                                ...
                                <input type="text" name="lokasi" class="cell-input yellow-cell" placeholder="Nama jalan / titik lokasi" required>
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Kota / Kab.</label>
                                <input type="text" name="kota" class="cell-input yellow-cell" required>
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Provinsi</label>
                                <input type="text" name="provinsi" class="cell-input" value="Jawa Timur">
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Latitude</label>
                                <input type="text" name="latitude" id="latitude" class="cell-input yellow-cell" placeholder="-7.xxxxxx">
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Longitude</label>
                                <input type="text" name="longitude" id="longitude" class="cell-input yellow-cell" placeholder="112.xxxxxx">
                            </div>
                            <div class="field-col-3">
                            ...
                            <div class="field-col-3">
                                ...
                                <input type="datetime-local" name="tanggal_survey" class="cell-input">
                            </div>
                ...
                <div class="excel-box mb-3">
                    ...
                    <div class="excel-box-body">
                        <div class="field-grid">
                            ...
                            <div class="field-col-3"><label class="field-label">Terlihat dr Jln Utama</label><select name="terlihat_jalan_utama" class="cell-input yellow-cell"><option value="1">Ya</option><option value="0">Tidak</option></select></div>
                            <div class="field-col-3"><label class="field-label">Posisi Hook</label><select name="posisi_hook" class="cell-input yellow-cell"><option value="1">Ya</option><option value="0">Tidak</option></select></div>
                            <div class="field-col-3"><label class="field-label">Frontage (m)</label><input type="number" name="frontage" class="cell-input yellow-cell"></div>
                            <div class="field-col-3"><label class="field-label">Terhalang Pohon/Kabel</label><select name="terhalang_pohon_kabel" class="cell-input yellow-cell"><option value="0">Tidak</option><option value="1">Ya</option></select></div>
                            <div class="field-col-3"><label class="field-label">Ruang Signage</label><select name="ruang_signage" class="cell-input yellow-cell"><option value="1">Ada</option><option value="0">Tidak Ada</option></select></div>
                            <div class="field-col-3"><label class="field-label">Penerangan Malam</label><select name="penerangan_malam" class="cell-input yellow-cell"><option value="1">Terang</option><option value="0">Gelap</option></select></div>
                    ...
                    <div class="excel-box-body">
                        ...
                        <div class="field-grid mt-2">
                            <div class="field-col-3">
                                ...
                                <input type="number" name="sekolah" class="cell-input yellow-cell facility-input calc-input" value="{{ $score->sekolah }}" min="0">
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Market <small class="text-muted">(max 5%)</small></label>
                                <input type="number" name="market" class="cell-input yellow-cell facility-input calc-input" value="{{ $score->market }}" min="0">
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Perkantoran <small class="text-muted">(max 2.5%)</small></label>
                                <input type="number" name="perkantoran" class="cell-input yellow-cell facility-input calc-input" value="{{ $score->perkantoran }}" min="0">
                            </div>
                            <div class="field-col-3">
                                <label class="field-label">Kesehatan <small class="text-muted">(max 2.5%)</small></label>
                                <input type="number" name="kesehatan" class="cell-input yellow-cell facility-input calc-input" value="{{ $score->kesehatan }}" min="0">
                            </div>
                        </div>
                    ...
                    <div class="excel-box-body">
                        <div class="field-grid">
                            ...
                            <div class="field-col-4">
                                ...
                                <input type="number" name="kompetitor_lokal" class="cell-input yellow-cell competitor-input calc-input" value="{{ $score->kompetitor_lokal }}" min="0">
                            </div>
                            <div class="field-col-4">
                                <label class="field-label">Harga Kompetitor</label>
                                <input type="number" name="harga_kompetitor" class="cell-input yellow-cell calc-input" value="{{ $score->harga_kompetitor }}" min="0">
                            </div>
                            <div class="field-col-12">
                                <label class="field-label">Catatan Surveyor</label>
                                <textarea name="catatan" class="cell-input" style="height:100px;padding-top:10px;" placeholder="Catatan kondisi lokasi, akses, kompetitor, parkir, dan potensi area.">{{ $score->catatan }}</textarea>
                            </div>
                            <div class="field-col-12">
            ...
            <div class="excel-box mb-3">
                ...
                <div class="excel-box-body">
                    <div class="field-grid">
                        <div class="field-col-3"><label class="field-label">Estimasi Renovasi</label><input type="number" name="rab_renovasi" class="cell-input yellow-cell" value="{{ $score->rab_renovasi ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Peralatan Dapur</label><input type="number" name="rab_kitchen" class="cell-input yellow-cell" value="{{ $score->rab_kitchen ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Signage</label><input type="number" name="rab_signage" class="cell-input yellow-cell" value="{{ $score->rab_signage ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Furniture</label><input type="number" name="rab_furniture" class="cell-input yellow-cell" value="{{ $score->rab_furniture ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Listrik</label><input type="number" name="rab_listrik" class="cell-input yellow-cell" value="{{ $score->rab_listrik ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Air</label><input type="number" name="rab_air" class="cell-input yellow-cell" value="{{ $score->rab_air ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Exhaust</label><input type="number" name="rab_exhaust" class="cell-input yellow-cell" value="{{ $score->rab_exhaust ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">AC / Kipas</label><input type="number" name="rab_ac_kipas" class="cell-input yellow-cell" value="{{ $score->rab_ac_kipas ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Perizinan</label><input type="number" name="rab_perizinan" class="cell-input yellow-cell" value="{{ $score->rab_perizinan ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Deposit Sewa</label><input type="number" name="rab_deposit_sewa" class="cell-input yellow-cell" value="{{ $score->rab_deposit_sewa ?? 0 }}"></div>
                        <div class="field-col-3"><label class="field-label">Biaya Opening</label><input type="number" name="rab_biaya_opening" class="cell-input yellow-cell" value="{{ $score->rab_biaya_opening ?? 0 }}"></div>
                        <div class="field-col-12 border-bottom pb-2 mt-2"></div>
                        <div class="field-col-4">
                            <label class="field-label">Kelebihan Lokasi</label>
                            <textarea name="kelebihan_lokasi" class="cell-input yellow-cell" style="height:60px;" placeholder="Cth: Ramai dekat pusat perbelanjaan...">{{ $score->kelebihan_lokasi }}</textarea>
                        </div>
                        <div class="field-col-4">
                            <label class="field-label">Kekurangan Lokasi</label>
                            <textarea name="kekurangan_lokasi" class="cell-input yellow-cell" style="height:60px;" placeholder="Cth: Parkiran sempit...">{{ $score->kekurangan_lokasi }}</textarea>
                        </div>
                        <div class="field-col-4">
                            <label class="field-label">Risiko</label>
                            <textarea name="risiko" class="cell-input yellow-cell" style="height:60px;" placeholder="Cth: Banjir saat hujan besar...">{{ $score->risiko }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="right-score-panel">
                ...
                <div class="score-card">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text" style="font-size: 11px;">Maksimal 5MB per foto. (Foto Depan, Kiri/Kanan, Dalam, Jalan, dll).<br>Peringatan: Mengunggah foto baru akan menimpa seluruh foto lama.</div>
                    </div>
                    
                    @if(isset($photos) && count($photos) > 0)
                        <div class="mt-3">
                            <label class="form-label" style="font-size: 13px; font-weight: 600;">Foto Tersimpan Sebelumnya:</label>
                            <div class="d-flex flex-wrap gap-2">
                                @foreach($photos as $photo)
                                    <div style="width: 100px; height: 100px; border-radius: 8px; overflow: hidden; border: 1px solid #e2e8f0;">
                                        <img src="{{ asset('storage/' . $photo->path) }}" alt="Foto" style="width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                @endforeach
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border-radius: 16px; border:none; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
            ...
            <div class="modal-body">
                ...
                <div id="aiResultArea" class="mt-4 d-none text-center">
                    <div class="mb-3">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Set photos if any (preview logic could be complex, skip for now or rely on text)
    // Trigger live score calculation
    setTimeout(() => {
        hitungLiveScore();
    }, 500);
